window.curatedPresetNames = [
  ...
  "flexi + cope - i blew you a soap bubble now what - feel the projection you are, connected to it all nz+ wrepwrimindloss w8",
  ...
  "Geiss - El Cubismo",
  "Geiss - Feedback 2",
  "Geiss - Flotsam - mash0000 - unfathomably advanced yet psychotic aliens churn my mental insides",
  ...
  "Idiot - Star Of Annon",
  "Illusion _ Rovastar - Dotty Mad Space (Jelly)",
  "iMuS and  Rovastar - The Shroomery (psilobellum)",
  "Ishan - Anuera",
  "Krash _ Rovastar - A Million Miles from Earth (Ripple Mix)",
  ...
  "Rovastar _ Idiot24-7 - Balk Acid",
  ...
  "Rozzor _ Shreyas - Deeper Aesthetics",
  "sawtooth grin roam",
  ...
  "Stahlregen _ Boz + Eo.S + Geiss + Phat + Rovastar + Zylot - Machine Code [Jelly]",
  "Stahlregen _ flexi + Geiss + Rovastar + Shifter - Fractal Feedback (for Hexcollie)",
  "stahlregen _ geiss + rovastar - fields of flowers (mashup 9 - space flower rmx) - mash0001 - pack em in, we got a long haul + flashlight",
  ...
  "TEcHNO _ SandStorm - Psychodelic Highway",
  "Telek - City Helix Lattice",
  "Telek - Sine Wave",
  "TonyMilkdrop - Leonardo Da Vinci's Balloon [Flexi - merry-go-round + techstyle]",
  "TonyMilkdrop - Magellan_s Nebula [Flexi - fancy + $this shall not retain]",
  "TonyMilkdrop - Magellan's Nebula [Flexi - you enter first + multiverse]",
  "Unchained _ Rovastar - Wormhole Pillars (Hall of Shadows mix)",
